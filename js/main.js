...
$(function() {
        var bookmark = {
            data: [{
                ...
                box_shadow: '#FA7199',
                icon: 'img/zuankeba.png',
            },
            {
                name: '线报酷',
                link: 'http://new.xianbao.fun/',
                box_shadow: '#F2584A',
                icon: 'img/xianbaoku.png',
            }, 
            {
                name: '今日热榜',
...
var time = d.getHours();
if (time < 24) {
    document.getElementById("title").innerHTML = "人间月亮导航 | Good evening";
}
if (time < 18) {
    document.getElementById("title").innerHTML = "人间月亮导航 | Good afternoon";
}
if (time < 12) {
    document.getElementById("title").innerHTML = "人间月亮导航 | Good morning";
}
if (time < 5) {
    document.getElementById("title").innerHTML = "人间月亮导航 | Stay up late again";
}
//title问候语结束
